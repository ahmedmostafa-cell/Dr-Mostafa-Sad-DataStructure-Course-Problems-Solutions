...
public:
    ...
    void link_utility(Node* prev, int value)
    {
        Node* to_add_node = new Node(value);
        add_node(to_add_node);
        to_add_node->Next = prev->Next;
        prev->Next = to_add_node;

    }
    void insert_sorted(int value)
    {
        if (value <= Head->data || !length)
        {
            insert_front(value);
        }
